...
export function Footer() {
    ...
    return (
        <footer className='shadow-[0_0px_10px_rgba(0,0,0,0.25)]'>
            <div className='p-4'>
                ...
                <div className='m-4 md:flex justify-between text-center'>
                    <div className='m-4 basis-full'>
                        <h2 className='text-2xl font-extrabold text-lime-500'>{t("legal")}</h2>
                        <p className='my-2 border-b-2 border-gray-300'></p>
                        <p>Viale Aldo Moro, 54</p>
                        <p>71043, Manfredonia (FG)</p>
                    </div>
                    <div className='m-4 basis-full'>
                        <h2 className='text-2xl font-extrabold text-lime-500'>{t("operative")}</h2>
                        <p className='my-2 border-b-2 border-gray-300'></p>
                        <p>Località Faralli</p>
                        <p>71022, Ascoli Satriano (FG)</p>
                    </div>
                    <div className='m-4 basis-full'>
                        <h2 className='text-2xl font-extrabold text-lime-500'>{t("contacts")}</h2>
                        <p className='my-2 border-b-2 border-gray-300'></p>
            ...
            <div className='p-4'>
                <p className='mx-4'>© 2025 Fimagri - {t("rights")}</p>
            </div>
        </footer>
    );
};